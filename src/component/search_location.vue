<template>
    <modal :show_modal="this.location_modal" v-on:fireclose="this.close_modal" class="zxw-modal-character">
    ...
    export default{
        ...
        data(){
            return {
                ...
                create_btn:true,
                search_content:'',
                search_url:'/ancient_books/get_location_list_by_name.action',
                search_result:[]
            }
        },
