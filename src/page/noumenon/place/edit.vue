    ...
    <div>
        ...
        <div style="margin-left:60px">
            ...
            <div class="zxw-character-row">
                ...
                <input id="pla_name" type="text"  class="zxw-character-input zxw-edit-character-input-margin zxw-input-placeholder" placeholder="请输入中文" v-model="input_content.location_name" v-bind:class="{'zxw-input-chinese':show_input}" onfocus="placeholder=''" @blur="pla_name_tip()">
            ...
            <div class="zxw-character-row">
                ...
                <input type="text" class="zxw-character-input zxw-input-placeholder" v-model="input_content.longitude" :="number_longitude" v-bind:class="{'zxw-input-chinese':show_longitude}">
            </div>

            <div class="zxw-character-row">
                <label class="zxw-character-span">纬度：</label>
                <input type="text" class="zxw-character-input zxw-edit-character-input-margin zxw-input-placeholder" v-model="input_content.latitude" :="number_latitude" v-bind:class="{'zxw-input-chinese':show_latitude}">
