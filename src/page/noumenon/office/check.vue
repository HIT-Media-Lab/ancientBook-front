...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            get_catalogue(){
                let object = {};
                let new_url=this.get_catalogue_url+'?id='+this.$route.params.nouId+'&&type=5';
            ...
            show_noumenon_location_2(index1,index2){
                ...
                let object = {};
                let new_url = this.get_noumenon_location+'?type=5&&id='+this.$route.params.nouId+'&&book='+this.catalogue[index1].book[index2]+'&&ancient_book_id='+this.catalogue[index1].id+'&&page='+this.$route.params.pageId;
            ...
            show_noumenon_location_1(index1,index2){
                ...
                let object = {};
                let new_url = this.get_noumenon_location+'?type=5&&id='+this.$route.params.nouId+'&&book='+this.catalogue[index1].book[index2]+'&&ancient_book_id='+this.catalogue[index1].id+'&&page=1';
                this.http_json(new_url,'get',object,this.success_show_location,this.fail_show_location);
            },
