    ...
    <div>
        ...
        <div style="margin-left:60px">
            ...
            <div class="zxw-character-row">
                ...
                <input id="person_name" type="text"  class="zxw-character-input zxw-edit-character-input-margin" v-model="input_content.name" v-bind:class="{'zxw-input-chinese':show_input}" :="repeat_nou_1">
            ...
            <div class="zxw-character-row">
                ...
                <div  class="zxw-character-input">
                    <div class="zxw-div-input" placeholder="点击右侧按钮添加" v-bind:contenteditable="input_content.institution_name !== ''">
                        <span class="zxw-person-relation-span"  @mouseover="show_ins = true" @mouseout="show_ins = false" v-if="input_content.institution_name !== ''">
                            <span v-model="input_content.institution_name" >{{input_content.institution_name}}</span>
            ...
            <div class="zxw-character-row">
                ...
                <div  class="zxw-character-input  zxw-edit-character-input-margin">
                    <div class="zxw-div-input" placeholder="点击右侧按钮添加" v-bind:contenteditable="input_content.s_office_name !== ''">
                        <span class="zxw-person-relation-span"  @mouseover="show_s_office = true" @mouseout="show_s_office = false" v-if="input_content.s_office_name !== ''">
                            <span v-model="input_content.s_office_name" >{{input_content.s_office_name}}</span>
            ...
            <div class="zxw-edit-btn">
                ...
                <button class="zxw-nextbtn zxw-nextbtn-length" @click="finish_edit()" v-bind:disabled="input_content.begin_time_name === ''|| input_content.end_time_name === ''||input_content.name === ''|| show_input === true|| repeat_id !== '' ||(add_data[0].remark_name === ''&& add_data[0].remark !== '')||(add_data[1] !== undefined && add_data[1].remark_name === '' && add_data[1].remark !=='')">完成</button>
            </div>
        </div>
