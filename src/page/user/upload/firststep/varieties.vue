    ...
    <div class="layer-input div-now">
        <div id="variety" class="form-center">
            <div>
                <div class="row">
                    <div class="col-md-2">
                        <label style="color: red">书名:</label>
                    </div>
                    <div class="col-md-4">
        ...
        <div id="ry-time-modal-v">
            <time_modal style="border: solid" :time_modal="this.time_modal_1" v-on:success_time="birth_time" v-on:close_modal="close_birth()"></time_modal>
