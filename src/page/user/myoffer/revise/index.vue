<template>
    <div class="all">
        <recent_title class="j-edit-bar" :title="'我的贡献/修订' + '（共' + this.count + '条）'"></recent_title>
        <div class="j-edit">
            <table class="table table-bordered j-table-box">
                ...
                <tbody>
                <tr > <!--v-for循环数据里的数组数据-->
                    <td class="j-edit-table" style="width: 400px"></td>
                    <td class="j-edit-table" style="width: 200px"></td>
                    <td class="j-edit-table" style="width: 200px"></td>
                </tr>
                </tbody>
            </table>
